...
from app.application.services.scrapper.LandRestScrapperStates import LandRestScrapperStates
...
class Dependencies(containers.DeclarativeContainer):
    ...
    land_rest_scrapper_states: providers.Factory[ILandRestScrapperStates] = providers.Factory(
        LandRestScrapperStates,
        data_base,
        get_data_service,
        upload_data_service ,
        browser_service
    ...
    scrapper_service: providers.Factory[IScrapperService] = providers.Factory(
        ScrapperService,
        land_rest_scrapper_states =land_rest_scrapper_states
    )
